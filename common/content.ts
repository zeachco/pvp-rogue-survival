...
export const SKILLS: Readonly<Record<SkillId, SkillDefinition>> = {
  ...
  vampiricBoomerang: { id: "vampiricBoomerang", label: "Vampiric Boomerang", damageMultiplier: 1.1, cooldown: 8, range: 260, resource: "life", description: "Spends 30% of remaining HP, then launches a huge fast crescent with half knockback that hits each foe on both legs and heals from their cumulative actual damage when it returns." },
  ...
  penance: { id: "penance", label: "Penance", damageMultiplier: 0, cooldown: 0, resource: "mana", passive: true, description: "After a successful buckler block, restores Mana equal to blocked damage × Spirit × level conversion (1% at level 1, up to 60% at level 99). Cannot exceed maximum Mana." },
  thorns: { id: "thorns", label: "Thorns", damageMultiplier: 0, cooldown: 0, resource: "stamina", passive: true, description: "Passive: returns 5% of incoming direct damage, even without a block." },
