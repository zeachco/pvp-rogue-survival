...
export interface SkillDefinition {
  ...
  description: string;
  passive?: boolean;
  upkeep?: { resource: "mana" | "stamina"; perLevelPerSecond: number };
  cost?: number;
...
export const SKILLS: Readonly<Record<SkillId, SkillDefinition>> = {
  ...
  flurry: { id: "flurry", label: "Flurry", damageMultiplier: 0.8, cooldown: 10, range: 105, resource: "stamina", description: "A fast dagger attack with shortened recovery and a wide close-range arc." },
  ...
  penance: { id: "penance", label: "Penance", damageMultiplier: 0, cooldown: 0, resource: "stamina", passive: true, upkeep: { resource: "stamina", perLevelPerSecond: 0.002 }, description: "Sustains its vigil with Stamina. After a successful buckler block, restores Mana equal to blocked damage × Spirit × level conversion (1% at level 1, up to 60% at level 99). Cannot exceed maximum Mana." },
  thorns: { id: "thorns", label: "Thorns", damageMultiplier: 0, cooldown: 0, resource: "stamina", passive: true, upkeep: { resource: "mana", perLevelPerSecond: 0.005 }, description: "Passive: returns 5% of incoming direct damage, even without a block." },
  reflectiveSurge: { id: "reflectiveSurge", label: "Reflective Surge", damageMultiplier: 0, cooldown: 16, range: 600, resource: "stamina", description: "When hit while ready, spends 3 Stamina and immediately surges for 6 seconds, doubling Thorns and block reflection while adding another 1% of incoming damage to every return." },
  ...
  blocking: { id: "blocking", label: "Blocking", damageMultiplier: 0, cooldown: 1, resource: "stamina", passive: true, upkeep: { resource: "stamina", perLevelPerSecond: 0.001 }, description: "An extractable passive that adds 1% base block chance per effective level while a buckler is equipped. Return bucklers divide recovery by main-hand attack speed." },
