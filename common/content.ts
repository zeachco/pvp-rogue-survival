...
export const SKILLS: Readonly<Record<SkillId, SkillDefinition>> = {
	...
	healing: {
		...
		resource: "mana",
		description:
			"Below 75% HP, restores level-scaled current health plus 5–10% maximum health and spends 2 mana per HP restored.",
	},
	rent: {
		id: "rent",
		label: "Rent",
...
export const AFFIXES: Readonly<Record<AffixId, AffixDefinition>> = {
	...
	venomous: {
		id: "venomous",
		compatibleWeapons: ["sword", "dagger", "axe", "throwingAxe", "staff"],
		modifierPerPower: { poisonChance: 0.1 },
	},
	bleeding: {
		id: "bleeding",
		compatibleWeapons: ["sword", "dagger", "axe", "throwingAxe"],
		modifierPerPower: { bleedChance: 0.08 },
	},
	stunning: {
		id: "stunning",
		compatibleWeapons: ["club", "mace", "hammer"],
