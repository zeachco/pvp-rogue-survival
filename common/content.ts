...
export const SKILLS: Readonly<Record<SkillId, SkillDefinition>> = {
  ...
  vampiricBoomerang: { id: "vampiricBoomerang", label: "Vampiric Boomerang", damageMultiplier: 1.1, cooldown: 8, range: 260, resource: "life", description: "Spends 30% of remaining HP, leaving at least 1 HP, adds the HP spent to damage, and launches a returning red crescent that heals from all damage it dealt." },
