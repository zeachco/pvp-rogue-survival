...
export function isSkillId(value: string): value is SkillId { return ["bash", "sweep", "flurry", "shockwave", "cleave", "rendingThrow", "orbitingHammers", "arcaneBolt", "gravityPull", "thorns", "reflectiveSurge", "frostOrb", "fireBreath", "voodoo", "healing", "rent", "blocking", "slowAura", "hinderingAura", "deathBurst", "sunburnAura", "thunderAura"].includes(value); }
