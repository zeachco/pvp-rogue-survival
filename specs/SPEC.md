...
- Show controls, drops, and inspected enemy highlight. Selecting a creep replaces the character column with its inspection details and shows the XP that defeating that creep is currently worth after mode and balance reward modifiers; Training Grounds therefore show 0 XP.
