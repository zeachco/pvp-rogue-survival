...
- Defeat is reported to the server. The server resets the player's authoritative wave number to 0, then sends that adjusted wave number back to the client and neighbor summaries.
