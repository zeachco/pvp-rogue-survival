...
export class SpellEffect extends GameObject {
  ...
  constructor(readonly kind: SpellEffectKind, readonly position: Vector2, readonly facing = 0) { super(); this.position = { ...position }; this.lifetime = kind === "healing" ? 0.9 : kind === "arcaneBolt" ? 0.65 : kind === "orbitingHammers" ? 0.8 : 0.55; }
