...
export class ArenaState {
  ...
  clear(): void {
    ...
    this.pendingPickups.clear(); this.blockedPickups.clear(); this.defeatedPositions.clear(); this.waveQueue.length = 0; this.events.length = 0; this.combatTexts.length = 0; this.spellEffects.length = 0;
  }
